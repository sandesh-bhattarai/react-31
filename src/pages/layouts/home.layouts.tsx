...
const HomePageLayout = () => {
    return (<>
        ...
        <footer className="p-4 mt-5 bg-teal-800 md:p-8 lg:p-10 dark:bg-gray-800">
            <div className="mx-auto max-w-screen-xl text-center">
                ...
                <p className="my-6 text-teal-200 dark:text-gray-400">Open-source library of over 400+ web components and interactive elements built for better web.</p>
                ...
                <span className="text-sm text-teal-200 sm:text-center dark:text-gray-400">© 2021-2022 <a href="#" className="hover:underline">Flowbite™</a>. All Rights Reserved.</span>
            </div>
        </footer>
    </>)
}
