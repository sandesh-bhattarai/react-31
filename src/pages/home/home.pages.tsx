    ...
    return (<>
        ...
        <div className="max-w-screen-xl my-5  px-4 mx-auto 2xl:px-0 py-4">
            <div className="flex items-center justify-between">
                <Card
                    className="max-w-sm me-3 p-3"
                    imgAlt="Meaningful alt text for an image that is not purely decorative"
                    imgSrc="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg"
                >
                    <NavLink to="/category-detail/electronics" className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Electronics
                    </NavLink>
                </Card>
                <Card
                    ...
                    imgSrc="https://flowbite.s3.amazonaws.com/blocks/e-commerce/imac-front.svg"
                >
                    <NavLink to="/category-detail/smart-phones" className="text-2xl font-bold tracking-tight text-gray-900 dark:text-white">
                        Smart Phones
                    </NavLink>
                </Card>
                <Card
        ...
        <section className="bg-gray-50 py-8 antialiased dark:bg-gray-900 md:py-12">
            <div className="mx-auto max-w-screen-xl px-4 2xl:px-0">
                ...
                <div className="mb-4 grid gap-4 sm:grid-cols-2 md:mb-8 lg:grid-cols-3 xl:grid-cols-4">
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="pt-6">
                            ...
                            <NavLink to="/product-detail/slug" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Apple iMac 27", 1TB HDD, Retina 5K Display, M3 Max</NavLink>
                            ...
                            <div className="mt-4 flex items-center justify-between gap-4">
                                ...
                                <button type="button" className="inline-flex items-center rounded-lg bg-teal-700 px-5 py-2.5 text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4  focus:ring-primary-300 dark:bg-primary-600 dark:hover:bg-teal-700 dark:focus:ring-primary-800">
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="pt-6">
                            ...
                            <NavLink to="/product-detail/slug" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Apple iPhone 15 Pro Max, 256GB, Blue Titanium</NavLink>
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="pt-6">
                            ...
                            <NavLink to="/product-detail/slug" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">iPad Pro 13-Inch (M4): XDR Display, 512GB</NavLink>
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="pt-6">
                            ...
                            <NavLink to="/product-detail/slug" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">PlayStation®5 Console – 1TB, PRO Controller</NavLink>
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="pt-6">
                            ...
                            <NavLink to="/product-detail/slug" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Microsoft Xbox Series X 1TB Gaming Console</NavLink>
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="pt-6">
                            ...
                            <NavLink to="/product-detail/slug" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Apple MacBook PRO Laptop with M2 chip</NavLink>
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="pt-6">
                            ...
                            <NavLink to="/product-detail/slug" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Apple Watch SE [GPS 40mm], Smartwatch</NavLink>
                    ...
                    <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-gray-800">
                        ...
                        <div className="pt-6">
                            ...
                            <NavLink to="/product-detail/slug" className="text-lg font-semibold leading-tight text-gray-900 hover:underline dark:text-white">Microsoft Surface Pro, Copilot+ PC, 13 Inch</NavLink>
                ...
                <div className="w-full text-center">
                    <button type="button" className="rounded-lg border border-gray-200 px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 dark:border-gray-600 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:focus:ring-gray-700">Show more</button>
                </div>
            </div>
                ...
                <div className="relative h-full w-full max-w-xl md:h-auto">
                    ...
                    <div className="relative rounded-lg bg-white shadow dark:bg-gray-800">
                        ...
                        <div className="flex items-center space-x-4 rounded-b p-4 dark:border-gray-600 md:p-5">
                            <button type="submit" className="rounded-lg bg-teal-700 px-5 py-2.5 text-center text-sm font-medium text-white hover:bg-primary-800 focus:outline-none focus:ring-4 focus:ring-primary-300 dark:bg-teal-700 dark:hover:bg-primary-800 dark:focus:ring-primary-800">Show 50 results</button>
